            ...
            <div className="flex flex-col mt-4">
                ...
                <div className="flex flex-col items-center">
                    <div className="relative z-10 text-black flex flex-col items-center rounded-xl w-36 bg-white r shadow-lg shadow-sky-500 h-10 mt-4">
                        ...
                        <button onClick={() => navigate('/experience')} class="relative gradient-border px-4 py-2 rounded-xl justify-between bg-black hover:bg-white hover:text-black opacity-95 hover:opacity-100 text-white w-full text-base font-normal transform hover:scale-105 duration-300">
                            See more
                        </button>
                    </div>
                </div>
